...
#ifndef _S32K358_FEATURES_H_
#define _S32K358_FEATURES_H_
...
#define FSL_FEATURE_SOC_FLEXCAN_COUNT (8)
...
/* @brief SAI availability on the SoC. */
#define FSL_FEATURE_SOC_SAI_COUNT (2)
...
/* @brief Code flash (PFLASH) implemented as 2 MiB blocks */

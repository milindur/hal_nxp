...
#ifndef _S32K358_GLUE_MCUX_H_
#define _S32K358_GLUE_MCUX_H_
...
#define USDHC0_BASE                              IP_USDHC_BASE
/** Peripheral USDHC base pointer */
#define USDHC0                                   IP_USDHC
/** Array initializer of USDHC peripheral base addresses */
#define USDHC_BASE_ADDRS                         IP_USDHC_BASE_ADDRS
/** Array initializer of USDHC peripheral base pointers */
#define USDHC_BASE_PTRS                          IP_USDHC_BASE_PTRS
...
#define SAI0_BASE                                IP_SAI_0_BASE
/** Peripheral SAI_0 base pointer */
#define SAI0                                     IP_SAI_0
/** Peripheral SAI_1 base address */
#define SAI1_BASE                                IP_SAI_1_BASE
/** Peripheral SAI_1 base pointer */
#define SAI1                                     IP_SAI_1
/** Array initializer of SAI peripheral base addresses */
#define SAI_BASE_ADDRS                           IP_SAI_BASE_ADDRS
/** Array initializer of SAI peripheral base pointers */
#define SAI_BASE_PTRS                            IP_SAI_BASE_PTRS
/** Interrupt vectors for the SAI peripheral type */
#define SAI_RX_IRQS                              { SAI0_IRQn, SAI1_IRQn }
#define SAI_TX_IRQS                              { SAI0_IRQn, SAI1_IRQn }
#endif  /* _S32K358_GLUE_MCUX_H_ */
